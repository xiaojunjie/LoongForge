...
from loongforge.models.diffusion.cosmos3.safetensors_loader import load_language_model, load_vlm_model
...
class HFModel(nn.Module):
    ...
    def __init__(
        ...
        if attn_implementation == "cosmos":
            ...
            from loongforge.utils.cosmos.vfm.hf_attention_cosmos import hf_attention_cosmos
        ...
        if hf_config.model_type == "qwen3_vl" and hasattr(self.model, "model"):
            from loongforge.utils.cosmos.vfm.monkey_patch import patch_qwen3_vl_forward
