...
from loongforge.utils.cosmos.lazy_config import instantiate
from loongforge.models.diffusion.cosmos3.base_model import ImaginaireModel
from loongforge.utils.cosmos import log
from loongforge.models.diffusion.cosmos3.cross_entropy_loss import cross_entropy_loss
from loongforge.train.diffusion.cosmos3.configs_pkg.base.defaults.parallelism import PRECISION_TO_TORCH_DTYPE
from loongforge.train.diffusion.cosmos3.configs_pkg.base.vlm.defaults.policy_config import VLMModelConfig
from loongforge.models.diffusion.cosmos3.hf_model import HFModel
from loongforge.models.diffusion.cosmos3.parallelize_vlm import parallelize
from loongforge.utils.cosmos.parallelism import ParallelDims
from loongforge.utils.cosmos.vlm.constant import IGNORE_INDEX
from loongforge.utils.cosmos.vlm.create_position_ids import get_position_ids
...
class VLMModel(ImaginaireModel):
    ...
    def __init__(self, config: VLMModelConfig, checkpoint):
        super().__init__()
        from loongforge.utils.cosmos.flash_attn import init_flash_attn_meta
    ...
    def _init_vlm(self, config: VLMModelConfig, checkpoint) -> None:
        ...
        """
        from loongforge.utils.cosmos.vlm.pretrained_models_downloader import (
