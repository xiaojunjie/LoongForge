...
from loongforge.utils.cosmos.lazy_config.file_io import PathManager
from loongforge.utils.cosmos.lazy_config.lazy_call import LazyCall, get_default_params
...
class LazyConfig:
    ...
    def save_yaml(cfg, filename: str) -> str:
        ...
        from loongforge.utils.cosmos.lazy_config.registry import convert_target_to_string
