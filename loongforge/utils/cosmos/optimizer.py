...
from loongforge.utils.cosmos.functional.lr_scheduler import LambdaLinearScheduler, LambdaWarmUpCosineScheduler
...
def _optimizer_cls(
    ...
    **optimizer_kwargs: Any,
    ...
    if optimizer_type.lower() == "adam":
        ...
        from loongforge.utils.cosmos.fused_adam import FusedAdam
