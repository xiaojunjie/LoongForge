...
if not INTERNAL:
    from loongforge.utils.cosmos.checkpoint_db import download_checkpoint
...
from loongforge.utils.cosmos.flags import EXPERIMENTAL_CHECKPOINTS, INTERNAL, StrEnum
