...
from loongforge.utils.cosmos.lazy_config import LazyCall as L
from loongforge.utils.cosmos.lazy_config import LazyDict
from loongforge.utils.cosmos import distributed
from loongforge.utils.cosmos.misc import Color
...
class TrainerConfig:
    if TRAINING:
        ...
        from loongforge.utils.cosmos import callback
...
def _reload_make_config_for_registrations(root_cfg: "Config") -> None:
    ...
    """
    from loongforge.utils.cosmos.serialization import load_callable
...
def load_config(config_path: str, opts: list[str], enable_one_logger: bool = False) -> Config:
    from loongforge.utils.cosmos.serialization import from_toml, from_yaml
    ...
    if config_path.endswith(".yaml"):
        ...
        from loongforge.utils.cosmos.config_helper import override
    ...
    if enable_one_logger:
        try:
            ...
            from loongforge.utils.cosmos.one_logger.one_logger_override_utils import override_one_logger_callback
...
def _load_py_config(config_path: str, opts: list[str], validate: bool = True) -> Config:
    ...
    from loongforge.utils.cosmos.config_helper import get_config_module, override
