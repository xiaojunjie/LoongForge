...
from loongforge.utils.cosmos.easy_io.backends import backends, prefix_to_backends
from loongforge.utils.cosmos.easy_io.file_client import FileClient
from loongforge.utils.cosmos.easy_io.handlers import file_handlers
...
def copyfile_from_local(
    ...
    Examples:
        >>> # dst is a file
        >>> src = '/path/of/file'
        >>> dst = 's3://bucket5/mmengine/file1'
        >>> # src will be copied to 's3://bucket5/mmengine/file1'
        >>> copyfile_from_local(src, dst)
        s3://bucket5/mmengine/file1

        >>> # dst is a directory
        >>> dst = 's3://bucket5/mmengine'
        >>> # src will be copied to 's3://bucket5/mmengine/file''
        >>> copyfile_from_local(src, dst)
        's3://bucket5/mmengine/file'
    """
...
def copytree_from_local(
    ...
    Examples:
        >>> src = '/path/of/dir'
        >>> dst = 's3://bucket5/mmengine/dir'
        >>> copyfile_from_local(src, dst)
        's3://bucket5/mmengine/dir'
    """
    backend = get_file_backend(dst, backend_args=backend_args, enable_singleton=True, backend_key=backend_key)
