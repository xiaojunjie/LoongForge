...
from loongforge.utils.cosmos.lazy_config.lazy import LazyConfig
from loongforge.utils.cosmos import distributed, log, object_store
from loongforge.utils.cosmos.easy_io import easy_io

if TYPE_CHECKING:
    from loongforge.utils.cosmos.config import CheckpointConfig, Config, JobConfig
...
def init_wandb(config: Config, model: ImaginaireModel) -> None:
    ...
    if isinstance(config.job, DictConfig):
        from loongforge.utils.cosmos.config import JobConfig
