...
from loongforge.utils.cosmos.easy_io.backends.auto_auth import json_load_auth, open_auth
...
def maybe_download_hf_model_from_s3(
    ...
    if not INTERNAL:
        from loongforge.utils.cosmos.checkpoint_db import CheckpointConfig, sanitize_uri
